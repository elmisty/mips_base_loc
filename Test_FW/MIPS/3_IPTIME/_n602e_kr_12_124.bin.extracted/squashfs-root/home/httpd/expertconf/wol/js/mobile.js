...
init_func['main'] = function()
{
	...
	if(cremotelist != 0)
	{
		...
		$('[sid="REMOTEPC_LIST"] li:even').css("background-color","#FAFAF7");
		$('[sid="REMOTEPC_LIST"] li:odd').css("background-color","#FAFAF7");
		$('[sid="REMOTEPC_LIST"] .ui-checkbox:even label').css("background-color","#FAFAF7");
		$('[sid="REMOTEPC_LIST"] .ui-checkbox:odd label').css("background-color","#FAFAF7");
	}
	else
	{
...
init_func['maclist'] = function()
{
	...
	if(cmaclist != 0)
	{
		...
		$('[sid="RIGHT_MACLIST"] li:odd').css("background-color","#F6F6F6");
	}
	iux_update("S");
