	...
	{	
		for (var i=0;i<cfreedevicelist;i++)
		{
			...
			if( ip[0] != ip[1] )
			{
				...
				+ '<div class="ip"><div style="width: 6.8em;"><p>'+ip[0]+'</p></div><div style="width: 1em;"><p>~</p></div><div style="width: 2em;"><p>'+endip[3]+'</p></div></div>'
				+ '<div class="desc"><p>'+freedevicelist[i].desc+'</p></div></li>');
			}
			else
			{
				$('[sid="FREEDEVICE_LIST"]').append('<li><div class="idx"><p>'+count+'</p></div>' 
				+ '<div class="ip"><div style="width: 6.8em;"><p>'+ip[0]+'</p></div><div style="width: 1em;"><p></p></div><div style="width: 2em;"><p></p></div></div>'
				+ '<div class="desc"><p>'+freedevicelist[i].desc+'</p></div></li>');
		...
		$('[sid="FREEDEVICE_LIST"] li:odd').css("background-color","#FFFFFF");
	}
	else
	{
...
init_func['del'] = function()
{
	...
	{	
		for (var i=0;i<cfreedevicelist;i++)
		{
			...
			if( ip[0] != ip[1] )
			{
				$('[sid="RIGHT_FREEDEVICE_LIST"]').append('<li><div sid="RLIST_'+i+'" style="width: 85%;"><div class="idx"><p>'+count+'</p></div>'
				+ '<div class="ip"><div style="width: 6.8em;"><p>'+ip[0]+'</p></div><div style="width: 1em;"><p>~</p></div><div style="width: 2em;"><p>'+endip[3]+'</p></div></div>'
		...
		$('[sid="RIGHT_FREEDEVICE_LIST"] li:odd').css("background-color","#FFFFFF");
		$('[sid="RIGHT_FREEDEVICE_LIST"] .ui-checkbox:even label').css("background-color","#FFFFFF");
		$('[sid="RIGHT_FREEDEVICE_LIST"] .ui-checkbox:odd label').css("background-color","#FFFFFF");
	}
	else
	{
