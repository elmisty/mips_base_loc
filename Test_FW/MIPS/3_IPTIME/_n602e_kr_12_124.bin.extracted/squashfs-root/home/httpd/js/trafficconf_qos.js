...
function changedIptype( doc )
{
	...
	{
		DisableObj(doc.rule_fm.ip1);
		DisableObj(doc.rule_fm.ip2);
		DisableObj(doc.rule_fm.ip3);
	...
	{
		EnableObj(doc.rule_fm.ip1);
		EnableObj(doc.rule_fm.ip2);
		EnableObj(doc.rule_fm.ip3);
