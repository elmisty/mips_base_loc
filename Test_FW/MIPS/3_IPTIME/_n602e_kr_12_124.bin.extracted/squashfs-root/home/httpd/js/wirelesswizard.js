...
function APModeGotoPage(step)
{
		...
		{
                        F.channel.value =  parent.iframe_scan.document.channellist_fm.channel.value;
		}
        }
        else if(step == 7)
        {
		...
		if(F.modechange && F.modechange.value == 1)
        ...
        {
                F.commit.value = 'manual_wireless_wizard';
		F.nextstep.value = 'finish5g';
        }
	else if(step == 'save5g2')
        {
                F.commit.value = 'manual_wireless_wizard';
		F.nextstep.value = 'finish5g2';
        }
