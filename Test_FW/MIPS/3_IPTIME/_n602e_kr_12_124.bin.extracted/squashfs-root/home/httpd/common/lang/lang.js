			...
			else
			{
				...
				{	
					...
					case "password":
						...
						if(typeof config_data[l_sid_s[VAL_ARTICLE]][l_sid_s[VAL_TAGNAME]] !== "object")
							$('[sid="' + sid + '"]').val(config_data[l_sid_s[VAL_ARTICLE]][l_sid_s[VAL_TAGNAME]]);
						break;
					case "slider":
						var value = config_data[l_sid_s[VAL_ARTICLE]][l_sid_s[VAL_TAGNAME]];
						if(typeof value !== "object")
							$('[sid="' + sid + '"]').val(value).slider('refresh');
						break;
				}
			}
		}
