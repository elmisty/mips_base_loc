...
function call_native(info)
{
	if(typeof Android != "undefined")
	{
		if(typeof Android.notify_setting_changes != "undefined")
		{
			Android.notify_setting_changes(info);
		}
	}
	...
	if(typeof window.webkit != "undefined")
	{
		...
		{
			if(typeof window.webkit.messageHandlers.notify_setting_changes != "undefined")
			{
				window.webkit.messageHandlers.notify_setting_changes.postMessage(info);
			}
		}
	}
}
