...
init_func['main'] = function()
{
	...
	var cbuilddateArr = cbuilddate.split(" ");
	
	$('[sid="CVERSION"]').html('<p>'+cversion+'</p>');
	$('[sid="CBUILDDATE"]').html('<pre>'+cbuilddateArr[0]+"  "+cbuilddateArr[1]+'</pre>');
