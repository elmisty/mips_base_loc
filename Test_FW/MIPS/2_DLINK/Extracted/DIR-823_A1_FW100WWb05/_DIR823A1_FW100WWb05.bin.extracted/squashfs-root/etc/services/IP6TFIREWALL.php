...
if ($def_policy != "DISABLE")
{
	...
	{
/* 
Alphanetworks, HuanYao:
We set default policy as DROP.
...
*/
		fwrite("a",$_GLOBALS["START"], 'ip6tables -A '.$CHAIN_POLICY.' -j ACCEPT\n');
	}
}
else
{
...
// HuanYao: IPv6 DOS by dlink.
// Set "/device/features/ipv6ddos" as "1" to enable this feature.
