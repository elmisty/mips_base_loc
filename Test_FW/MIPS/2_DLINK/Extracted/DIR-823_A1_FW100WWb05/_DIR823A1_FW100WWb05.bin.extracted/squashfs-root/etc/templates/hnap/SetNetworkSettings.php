...
if($DeviceName != "" && isdomain($DeviceName)!=1)                       { $result = "ERROR"; }
else if($local_domain_name != "" && isdomain($local_domain_name)!=1)    { $result = "ERROR"; }
else if($ipaddress !="" && $ipaddress != "0.0.0.0" && INET_validv4addr($ipaddress)==0)    { $result = "ERROR"; }
