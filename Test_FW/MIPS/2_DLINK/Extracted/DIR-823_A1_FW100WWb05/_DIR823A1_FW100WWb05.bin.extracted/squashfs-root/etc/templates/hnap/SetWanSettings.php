...
if($rlt == "OK")
{
	...
	if($Type == "Static")
	{
		...
		//Work around the issue from D-Link OBU: Change MTU to 1300 and change back to 1492, MTU still 1300 actually after save settings. Reboot will resolve this issue.
		$mtu_old = get("", "mtu");
		if($MTU == "0" && $mtu_old == "1500")	{}
		else if($MTU != $mtu_old)				{$rlt="REBOOT";}
		if($MTU == "0")
		{
