...
else
{
	...
	$over = query($path_wan1_inet."/ppp4/over");
	if($mode == "ppp4")
	{
		if($over == "eth") { $PPPoE_IPv4 = "true"; }
		else if($over == "pptp") { $Is_PPTP = "true"; }
		else if($over == "l2tp") { $Is_L2TP = "true"; }
	}
	...
	else if($mode == "ppp10" || $PPPoE_IPv4 == "true")
	{
		...
		{
			$ipaddr = get("x", $path_run_inf_wan1."/inet/ppp4/local");
		}
	}
	else if($Is_PPTP == "true" || $Is_L2TP == "true")
	{
		$ipaddr = get("x", $path_run_inf_wan1."/inet/ppp4/local");
	}
