...
{
	set($phyp_wlan_24."/active", "1");
	set($phyp_wlan_5."/active", "0");	/* disable 5G */
	set($phyp_wlan_5."/media/channel", "149");	/* default 5G channel set 149 */
	$path_phyinf_wlan = $phyp_wlan_24;
	$freq = "2.4";
	$wlmode = "bgn";
	$bw = "20+40";
}
...
{
	set($phyp_wlan_5."/active", "1");
	set($phyp_wlan_24."/active", "0");	/* disable 2.4G */
	set($phyp_wlan_24."/media/channel", "6");	/* default 2.4G channel set 6 */
	$path_phyinf_wlan = $phyp_wlan_5;
	$freq = "5";
...
set($path_phyinf_wlan."/media/channel", $ch);
...
else if(strstr($SecurityType, "WPA") != "")
{
	...
	else if(strstr($SecurityType, "WPA+2PSK") != ""){$auth = "WPA2PSK";}
	else	{$result = "ERROR_BAD_SECURITYTYPE";}

	if(strstr($Encryptions, "TKIPAES") != "")	{$encrypttype = "AES";}
	else if(strstr($Encryptions, "TKIP+AES") != "")	{$encrypttype = "AES";}
