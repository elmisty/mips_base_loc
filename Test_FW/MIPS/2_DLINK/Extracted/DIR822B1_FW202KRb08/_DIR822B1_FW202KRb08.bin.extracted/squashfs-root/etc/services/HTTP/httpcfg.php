...
function prd_server($prd_name, $uid, $ifname, $af, $ipaddr, $port)
{
	echo
		'Server'.									'\n'.
		'{'.										'\n'.
...
$prd_name = "Linux, PAGEREDIRECT/1.0, ".$model." Ver ".$ver;	/* PAGEREDIRECT server name */		
foreach("/runtime/services/http/server")
{
	...
	if($ifname!="" || $ipaddr!="")
	{
		if ($af!="")
		{
			...
			else if ($mode=="PRD") prd_server($prd_name,$inf,$ifname,$af,$ipaddr,$port);
		}
	}
}
/*
