...
if($NTP=="true")
{
    if($NTPServer=="")
	{
		TRACE_debug("NTPServer is empty \n");
		$result = "ERROR_SERVERNAME";
	}
	else
	{
		if(isdomain($NTPServer)== "1" || ipv6checkip($NTPServer) == "1" || INET_validv4addr($NTPServer) == "1")
		{ $result = "OK"; }
		else 
		{ 
			TRACE_debug("NTPServer is invalid \n");
			$result = "ERROR_SERVERNAME"; 
		}
	}	
}
