...
if($result == "OK")
{
	fwrite("a",$ShellPath, "xmldbc -k \"HNAP_PHYINF.WIFI\"\n");
	fwrite("a",$ShellPath, "xmldbc -t \"HNAP_PHYINF.WIFI:3:service PHYINF.WIFI restart\"\n");
	fwrite("a",$ShellPath, "xmldbc -k \"HNAP_INET.LAN-2\"\n");
	fwrite("a",$ShellPath, "xmldbc -t \"HNAP_INET.LAN-2:3:service INET.LAN-2 restart\"\n");
	fwrite("a",$ShellPath, "xmldbc -k \"HNAP_DHCPS4.LAN-2\"\n");
	fwrite("a",$ShellPath, "xmldbc -t \"HNAP_DHCPS4.LAN-2:3:service DHCPS4.LAN-2 restart\"\n");
