...
$IPTVPort=query($nodebase."IPTVPort");
$IPTVPort_org=query("/device/iptv/port");
$result = "OK";
...
if($IPTVPort != $IPTVPort_org)
{
	set("/device/iptv/port", $IPTVPort);
	set("/device/vlan/lanport/lan1","");
	set("/device/vlan/lanport/lan2","");
	set("/device/vlan/lanport/lan3","");
	set("/device/vlan/lanport/lan4","");
	if($IPTVPort == 1) // DIR-822 sequence is differnet...
		set("/device/vlan/lanport/lan4","600");
	else if($IPTVPort == 2)
		set("/device/vlan/lanport/lan3","600");
	else if($IPTVPort == 3)
		set("/device/vlan/lanport/lan2","600");
	else if($IPTVPort == 4)
		set("/device/vlan/lanport/lan1","600");
	$iptv_change = 1;
}
