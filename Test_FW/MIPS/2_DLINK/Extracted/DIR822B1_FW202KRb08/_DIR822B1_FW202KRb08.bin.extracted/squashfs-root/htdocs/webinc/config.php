...
//	$WLAN1_GUEST = "BAND24G-1.2";	
	...
	$LAN3  = "LAN-3";
	$LAN4  = "LAN-4";		
	$LAN5  = "LAN-5";   // IPv6 guest zone.
	$LAN6  = "LAN-6"; 
	$BR1= "BRIDGE-1";
	$WLAN1_REP	 = "BAND24G-REPEATER";
	$WLAN2_REP	 = "BAND5G-REPEATER";
	$WLAN_APCLIENT = "BAND24G-REPEATER";
	$WLAN2_APCLIENT = "BAND5G-REPEATER";
	...
	/*---HNAP---*/
	$HNAP_AVAILABLE_OP_MODE = "WirelessRouter";  /* opmode list for HNAP  ex: WirelessRouter,WirelessAp*/
	...
	$FEATURE_IPTV = 1; 			/* if this model has IPTV port setting, set it as 1.*/	
	$FEATURE_HAVEAPCLIENT = 1;/* if this model has ap client, set it as 1.*/
	$FEATURE_HAVEREPEATER = 1;/* if this model has repeater, set it as 1.*/
	$FEATURE_HAVEEXTENDER = 1;/* if this model has extender mode, set it as 1.*/
?>
