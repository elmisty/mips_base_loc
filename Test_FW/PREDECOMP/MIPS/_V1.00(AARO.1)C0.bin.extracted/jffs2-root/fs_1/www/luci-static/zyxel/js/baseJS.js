...
function showFullPath(str){fr =2;parent.frames[fr].document.open();parent.frames[fr].document.writeln(' <html>');parent.frames[fr].document.writeln(' <head>');parent.frames[fr].document.writeln(' <meta http-equiv=\"Content-Type\" content=\"text\/html; charset=iso-8859-1\">');	parent.frames[fr].document.writeln(' <title>.::Welcome to ZyXEL NBG6616::.<\/title>');parent.frames[fr].document.writeln(' <link href=\"\/luci-static\/zyxel\/css\/expert.css\" rel=\"stylesheet\" type=\"text/css\">');parent.frames[fr].document.writeln(' <\/head>');parent.frames[fr].document.writeln(' <body>');	parent.frames[fr].document.writeln(' <div class=\"path\">');parent.frames[fr].document.writeln(' <span class=\"i_path\">'+str+'<\/span>');parent.frames[fr].document.writeln(' <\/div>');parent.frames[fr].document.writeln(' <\/body>');parent.frames[fr].document.writeln(' <\/html>');	parent.frames[fr].document.close();}
