...
sys   = Linux
sig   = 1:Host,Connection=[keep-alive],User-Agent=[Mozilla/5.0 (X11; CrOS],Accept-Encoding=[gzip,deflate,sdch],Accept-Language,Accept-Charset:Keep-Alive:Mozilla/5.0 (X11; CrOS
...
sys   = Linux
sig   = 1:User-Agent=[; SM-N900V Build]::; SM-N900V Build
...
label = s:!:WebClient:WindowsPhone
sys   = Windows
